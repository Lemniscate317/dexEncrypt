...
/**
 * Created by Lemniscate on 2019/5/19.
 */
...
public class ProxyApplication extends Application {
    ...
    protected void attachBaseContext(Context base) {
        ...
        try {
            ...
            //art 不会出现 反之会
            try{
                Object actObj = dLoader.loadClass("com.l.origin.MainActivity");
                Log.i("demo", "actObj:"+actObj);
            }catch(Exception e){
                Log.i("demo", "activity:"+Log.getStackTraceString(e));
            }
        } catch (Exception e) {
            Log.e(ProxyApplication.class.getName(), Log.getStackTraceString(e.fillInStackTrace()));
        }
